...
function [jac, res] = ass_unifstrains (elements, coordinates, bc_nods, strain_mac, nx, ny, lx, ly, u_n)
...
res([bc_nods*dim - 1; bc_nods*dim]) = u_n([bc_nods*dim - 1; bc_nods*dim]) - u_d;
